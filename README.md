## Luis Henrique Azevedo

**Desenvolvedor de software — sistemas web, dashboards e automações com IA.**
Manaus, AM · Estudante de Engenharia de Software na Fametro.

Construo aplicações completas: modelagem de dados, API, interface e publicação.
A maior parte dos meus projetos nasceu de um problema concreto — meu, da minha
família ou de um negócio local — e não de um exercício de curso.
...
**Linguagens** — TypeScript · JavaScript · Python · SQL · C
...
**IA** — Claude API (Anthropic SDK) · OpenAI API · Tesseract.js (OCR)
...
- Cursando Engenharia de Software (Fametro, Manaus).
- Aprofundando arquitetura de aplicações Next.js, modelagem de dados e testes automatizados.
- Construindo sistemas locais-first com Prisma e SQLite, e integrações com modelos de linguagem.
